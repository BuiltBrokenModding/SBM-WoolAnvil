...
import com.builtbroken.woolanvil.lib.network.PacketAnvilRename;
...
public class GuiGenericAnvil extends GuiContainer implements IContainerListener
{
    ...
    private static final ResourceLocation hammer = new ResourceLocation(WoolAnvils.DOMAIN, "textures/gui/hammer.png");
    private final InventoryPlayer playerInventory;
    private ContainerGenericAnvil anvil;
    private GuiTextField nameField;


    public GuiGenericAnvil(InventoryPlayer inventoryIn, World worldIn, BlockAnvil genericAnvil)
    {

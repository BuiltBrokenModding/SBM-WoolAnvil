...
public class CommonProxy {
  ...
  public static void registerEntity(RegistryEvent.Register<EntityEntry> e) {
    ...
    final ResourceLocation resourceLocation = new ResourceLocation(WoolAnvils.MODID, "falling_anvil");
  ...
  public void preInit(FMLPreInitializationEvent e) {
    ...
    PacketHandler.registerMessages(WoolAnvils.MODID);
  }

  public void init(FMLInitializationEvent e) {
    NetworkRegistry.INSTANCE.registerGuiHandler(WoolAnvils.instance, new GuiHandler());

    for (BlockGenericAnvil anvil : WoolAnvils.anvils) {
      switch (anvil.variant) {
        case NORMAL:
          WoolAnvils.anvilDamageMap
        ...
        case CHIPPED:
          ...
          break;
        case DAMAGED:
          WoolAnvils.anvilDamageMap.put(anvil, null);
          break;
      }
    }
  }
